...
async def on_member_join(member):
    ...
    if used_invite:
        ...
        personal_invites_button = Button(color=discord.ButtonStyle.green, label="Voir mes invitations", onclick_code="await interaction.response.send_message(get_invites_count(user), ephemeral=True)", json_file=None, interaction_msg=None)
        await channel.send(
