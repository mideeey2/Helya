...
async def on_member_join(member):
    ...
    if used_invite:
        ...
        await channel.send(
            ...
            embed=discord.Embed(title=f"{member.mention} a rejoint le serveur, il a été invité par <@{inviter.id}> qui a désormais {invites_count[inviter_id]} invitations! <a:pepeclap:1453682464181588065>", color=0x00ff00),
